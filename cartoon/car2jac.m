function [ dFdy ] = car2jac( t, y1 )
%CAR2JAC Jacobian matrix of cartoon model
%   CAR2JAC - vector y contains all the 5*N (c,a,V,phi,j) variables in the model
%   
...
dFdy = double(subs(dF, y, y1)); % Jacobian matrix of cartoon model numerically
